...
import hal.hem.mixin.EntityMixin;
...
public interface ITeleporter
{
     ...
     *
     * @return the entity in the new World. Vanilla creates for most {@link Entity}s a new instance and copy the data. But <b>you are not allowed</b> to create a new instance for {@link Player}s! Move the player and update its state, see {@link EntityMixin#changeDimensionForge(ServerLevel, ITeleporter)}
     */
    ...
    {
        return this.isVanilla() ? defaultPortalInfo.apply(destWorld) : new PortalInfo(entity.position(), Vec3.ZERO, entity.yRot, entity.xRot);
    }
